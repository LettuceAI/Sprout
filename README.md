...
GPU detection is split by vendor: NVML for NVIDIA, Vulkan for AMD and Intel, and Metal for Apple. It uses only the drivers already on the machine and ships as a single binary.
